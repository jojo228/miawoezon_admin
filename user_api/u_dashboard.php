...
$h = new Estate();
	...
	$papi = array(array("title"=>"Mes Propriétés","report_data"=>$total_property,"url"=>'images/dashboard/property.png'),array("title"=>"Images Supplementaires","report_data"=>$total_extra_image,"url"=>'images/dashboard/extra_images.png'),array("title"=>"Catégorie De Ma Galerie","report_data"=>$total_gallery_category,"url"=>'images/dashboard/category.png'),array("title"=>"Images De Ma Galerie","report_data"=>$total_gallery_image,"url"=>'images/dashboard/gallery_image.png'),array("title"=>"Mes Réservations","report_data"=>intval($total_Booking),"url"=>'images/dashboard/my-booking.png'),array("title"=>"Mes Revenus","report_data"=>$finalearn,"url"=>'images/dashboard/my-earning.png'),array("title"=>"Renseignements","report_data"=>intval($total_enquiry),"url"=>'images/dashboard/my-inquiry.png'),array("title"=>"Revues Total","report_data"=>$total_review,"url"=>'images/dashboard/review.png'),array("title"=>"Mes Remunérations","report_data"=>floatval($payout),"url"=>'images/dashboard/my-payout.png'));
